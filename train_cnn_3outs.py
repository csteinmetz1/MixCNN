...
def load_data():
    ...
    # crate array of length 3 loudness ratios - exclude the bass of value 1
...
# add callback to save network weights at the end of each training cycle - n_folds
# also save out training losses from each epoch of each fold and then create script to plot them
